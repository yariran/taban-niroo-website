  ...
  return (
    <section ref={sectionRef} className="relative bg-background">
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              <div 
                className="absolute inset-0 flex flex-col items-end justify-end overflow-hidden pb-2 md:pb-4"
              ...
              >
                ...
                <p className="w-full text-[4vw] font-medium tracking-tight text-white/95 md:text-[3vw]">
                  INNOVATE, INTEGRATE
                </p>
              </div>
            </div>
      ...
      <div className="px-6 pt-32 pb-28 md:pt-48 md:px-12 md:pb-36 lg:px-20 lg:pt-56 lg:pb-44">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-center text-base leading-relaxed text-muted-foreground/90 md:text-lg">
          High-voltage composite insulators. Power transmission. 11 kV–1000 kV. IEC. Shiraz, Iran.
        </p>
      </div>
    </section>
  );
