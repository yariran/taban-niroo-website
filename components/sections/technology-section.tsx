...
const sideImages = [
  ...
  {
    src: "/images/_MG_0387.jpg",
    alt: "Power transmission equipment",
    position: "left",
    span: 1,
  },
  {
...
export function TechnologySection() {
  ...
  const descriptionText = "IEC 61109, 62217, 61466, 60120, 60471. ECR core. HTV silicone. Galvanized fittings. Accredited laboratories. 11 kV–1000 kV.";
            ...
            >
              ...
              >
                <h2 className="max-w-3xl font-medium leading-tight tracking-tight text-white md:text-5xl lg:text-7xl text-5xl">
                  {["IEC.", "Standard.", "Industrial."].map((word, index) => {
